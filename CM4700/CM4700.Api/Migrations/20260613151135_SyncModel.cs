        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ElementReference = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ResultLabel = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AiFindings_ScanRequests_ScanRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AiFindings_ScanRequestId",
                table: "AiFindings",
